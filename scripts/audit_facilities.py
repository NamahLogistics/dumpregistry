...
SOURCE_ALLOWLIST = frozenset({
    ...
    "flcounties.com",
    "kernpublicworks.com",
    # City / county / authority portals flagged in audit warnings
    "gwinnettcb.org",
    "cctexas.com",
    "jeffco.us",
    "slco.org",
    ...
    "spsa.com",
    "suffolkva.us",
    "communityresources.elpasoco.com",
    ...
    "cityofirving.org",
    "bcc.columbiacountyfla.com",
    "coj.net",
    "nassaucountyfl.com",
    "sjcfl.us",
    "southernnevadahealthdistrict.org",
    "cityofnorthlasvegas.com",
    "laredosolidwaste.com",
    "laredoenvironmental.com",
    ...
    # Wave-21a / metro portal allowlist additions
    "augustaga.gov",
    "bellevuewa.gov",
    "bridgeportct.gov",
    "brownsvilletx.gov",
...
_US_STATE_TLDS = frozenset(s.lower() for s in US_STATE_ABBR)
...
def is_official_source(url: str) -> bool:
    ...
    if parts[-1] == "gov" or (len(parts) >= 2 and parts[-2] == "gov"):
        return True
    # US locality portals: co.davidson.nc.us, henrico.us, clackamas.us, city.X.st.us
    if host.endswith(".us"):
        if len(parts) >= 2 and parts[-2] in _US_STATE_TLDS:
            return True
        if len(parts) == 2:
            return True  # short county/city brands on .us (jeffco.us, henrico.us)
        if parts[0] in {"co", "county", "city", "ci", "town", "township", "parish", "boro"}:
            return True
