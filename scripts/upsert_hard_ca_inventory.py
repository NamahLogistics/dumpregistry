...
FACILITIES: list[dict] = [
    ...
    row("Sycamore Landfill — public drop-off", "Regional landfill — self-haul", "san-diego", "92071", "8514 Mast Boulevard, Santee, CA 92071", 32.8555, -116.9855, "https://www.sandiego.gov/sites/default/files/leainfo_sycamoreapp.pdf", "Mon–Fri 6:00–16:30; Sat 6:00–15:00", "619-562-0530", LANDFILL),
    # chula-vista
