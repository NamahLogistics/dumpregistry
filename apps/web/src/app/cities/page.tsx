...
export const metadata: Metadata = pageMetadata({
  title: "U.S. cities with verified disposal guides",
  description:
    "Browse city-sourced bulky, HHW, and e-waste guides — no statewide filler. Mattress, paint, fridge, and 70-item grids.",
  path: "/cities",
});
